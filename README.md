...
[![Latest Release](https://img.shields.io/github/v/release/monsivamon/android-oss-tracker)](https://github.com/monsivamon/android-oss-tracker/releases/latest)
...
Get the latest pre-built APK from the **[Releases Page](https://github.com/monsivamon/android-oss-tracker/releases)**.
